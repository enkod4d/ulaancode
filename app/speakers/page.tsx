                ...
                <div className="col-lg-3 col-md-6">
                  <div className="our-team-boxarea">
                    <div className="team-widget-area">
                      ...
                      <div className="img1">
                        <img
                          src="/assets/img/all-images/team/team-img15.png"
                          alt=""
                          className="team-img4"
                        />
                        <div className="share">
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="our-team-boxarea">
                    <div className="team-widget-area">
                      ...
                      <div className="img1">
                        <img
                          src="/assets/img/all-images/team/team-img16.png"
                          alt=""
                          className="team-img4"
                        />
                        <div className="share">
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="our-team-boxarea">
                    <div className="team-widget-area">
                      ...
                      <div className="img1">
                        <img
                          src="/assets/img/all-images/team/team-img17.png"
                          alt=""
                          className="team-img4"
                        />
                        <div className="share">
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="our-team-boxarea">
                    <div className="team-widget-area">
                      ...
                      <div className="img1">
                        <img
                          src="/assets/img/all-images/team/team-img18.png"
                          alt=""
                          className="team-img4"
                        />
                        <div className="share">
                ...
                <div className="col-lg-3 col-md-6">
                  <div className="our-team-boxarea">
                    <div className="team-widget-area">
                      ...
                      <div className="img1">
                        <img
                          src="/assets/img/all-images/team/team-img19.png"
                          alt=""
                          className="team-img4"
                        />
                        <div className="share">
