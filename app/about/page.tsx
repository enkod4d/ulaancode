                ...
                <div className="col-lg-6">
                  <div className="about-header-area heading2">
                    ...
                    <p data-aos="fade-left" data-aos-duration={900}>
                      The Yearly Designer Conferences designed to challenge,
                      Event inspire, and push the boundaries of what is possible
                      in design. From emerging technologies to sustainable
                      design practices.
                    </p>
