                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-lg-7">
                        <div className="speakesr-details-content heading2">
                          ...
                          <div className="space16" />
                          <p>
                            Kireon Pollardy is a renowned business strategist
                            and thought leader with over 15 years of experience
                            in guiding companies through transformational
                            growth. As and expert in innovation an leadership,
                            Kireon has worked with global brands, helping them
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-7">
                              <div className="heading2">
                                ...
                                <div className="space16" />
                                <p>
                                  His passion for fostering creativity and
                                  driving strategic change has made him a
                                  sought-after speaker at top business
                                  conferences around the world. At meet Eventify
                                  2024, Kireon will share his the unique
                                  insights on future-proofing best businesses,
                                  offering practical strategies to help
                                  organizations stay agile and on competitive in
                                  a rapidly changing meet environment knowledge
                                  and real-world.
                                </p>
                              </div>
                            </div>
